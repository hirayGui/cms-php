            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="list-group">
                        ...
                        <a href="index.php" class="list-group-item list-group-item-action active main-color-bg" aria-current="true"><i class="bi bi-newspaper"></i> Posts <span class="badge">5</span></a>
