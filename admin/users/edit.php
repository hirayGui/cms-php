...
<body>
    ...
    <header id="header">
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1><i class="bi bi-people-fill"></i>Usuários <small>Editar usuário</small></h1>
                </div>
                <!--col-md-10-->
            </div>
            <!--row-->
    ...
    <section id="breadcrumb-divider">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <lo class="breadcrumb-item active">Editar usuário</lo>
            </ol>
        </div>
        <!--container-->
    </section>
                            ...
                            <div class="col-md-4"><label>Status</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="status"
                                        <?php if ($rows['ds_status'] == 'ativo') { ?> checked<?php } ?> value="ativo">
